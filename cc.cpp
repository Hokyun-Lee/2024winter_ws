...
void CustomController::computeSlow()
{
    ...
    {   
        ...
        Eigen::VectorXd torque_com_task1;
        torque_com_task1.setZero(33);
        torque_com_task1.segment(12,21) = (Jtask1.transpose() * Lambda1 * fstar1).segment(18,21);
        ...
        Eigen::VectorXd torque_upper_mode6;
        torque_upper_mode6.setZero(33);
        torque_upper_mode6 = rd_.torque_grav.segment(12,21);
        rd_.torque_desired = torque_pos_hold + torque_com_task1 + torque_upper_mode6;
        ...
        // rd_.torque_desired = torque_pos_hold + torque_com_task1;
        ...
        // // Eigen::MatrixXd Lambda2 = (Jtask2 * rd_.A_inv_ * rd_.N_C * Jtask2.transpose()).inverse();
        // // Eigen::VectorXd torque_upper = 
        // // (Jtask2.transpose() * lambda2 * fstar2).segment(18,21);
